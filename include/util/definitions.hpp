...
extern pros::Rotation track_encoder_forward;
extern pros::Rotation track_encoder_side;
...
const QLength TRACK_FORWARD_OFFSET = 6.125_in;
const QLength TRACK_SIDE_OFFSET = 3_in;

/* ------------------------ Drivetrain ----------------------- */
const QLength DRIVE_WHEEL_DIAMETER = 3.76_in;
...
const QSpeed DRIVE_MAX_SPEED = 1.8_mps; // a measured linear velocity

/* ------------------------- Settings ------------------------ */
const double SET_DT_MAX = 1; // default drivetrain max speed (1 is 100%)
const OdomState SET_ODOM_START = {0_in, 0_in, 90_deg}; // starting position of the robot on the field
} // namespace def
